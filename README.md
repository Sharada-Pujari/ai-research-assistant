# AI Research Assistant - Agentic AI Project
...
### Agent System
1. **SearchAgent**: Finds and gathers information from the web
2. **AnalyzerAgent**: Processes and analyzes the collected data
3. **ReportAgent**: Generates comprehensive reports
